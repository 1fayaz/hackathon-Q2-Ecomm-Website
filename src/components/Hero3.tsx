...
const Hero3 = () => {
  return (
    <div className=" flex flex-col items-center justify-center text-center py-7 px-4 mx-auto my-0 max-w-screen-2xl   bg-white">
      ...
      <a href="/products"><button  data-aos="flip-down" className="bg-black border   hover:text-black  text-white px-6 py-3 rounded-full hover:bg-white transition">
          Notify Me
        </button></a>
        <Link href="/products">
        <button  data-aos="flip-down" className=" bg-black border  text-white hover:text-black px-6 py-3 rounded-full hover:bg-white  transition">
          Shop Air Max
        </button>
        </Link>
      </div>
